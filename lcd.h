...
#define OLED_DisplayPgmString(str)             _OLED_DisplayPgmString((uint16_t)(str))
#define OLED_Display12PgmString(row, col, str) _OLED_Display12PgmString((row), (col), (uint16_t)(str))
